...
def return_prediction(model, scaler, sample_json):
    ...
    flower_s = scaler.transform(flower)
    class_ind_prob = model.predict(flower_s)
    class_ind = np.argmax(class_ind_prob, axis = 1)[0]
...
flower_model = load_model("my_iris_model.h5")
flower_scaler = joblib.load("my_iris_scaler.pkl")
